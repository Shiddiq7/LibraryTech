        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg" style="border-radius: 12px; overflow: hidden;">
                ...
                <div class="modal-body">
                    <p class="lead">Apakah Anda yakin ingin mengonfirmasi peminjaman buku ini?</p>
                    <ul id="confirmDetails" class="list-group list-group-flush"></ul>
                </div>
                <div class="modal-footer border-0">
                    <form method="POST" id="confirmForm" class="w-100 d-flex justify-content-between">
                        <input type="hidden" name="id_pinjam" id="confirmIdPinjam">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                        <button type="submit" class="btn btn-primary" name="confirmPinjam">Konfirmasi</button>
                    </form>
                </div>
            </div>
        </div>
